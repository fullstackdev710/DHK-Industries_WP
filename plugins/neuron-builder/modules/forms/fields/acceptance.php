...
class Acceptance extends Field_Base {
	...
	public function get_name() {
		return __( 'Acceptance', 'neuron-builder' );
	}
	...
	public function update_controls( $widget ) {
		...
		$field_controls = [
			'acceptance_text' => [
				...
				'label' => __( 'Acceptance Text', 'neuron-builder' ),
			...
			'checked_by_default' => [
				...
				'label' => __( 'Checked by Default', 'neuron-builder' ),
	...
	public function render( $item, $item_index, $form ) {
		$label = '';
		$form->add_render_attribute( 'input' . $item_index, 'class', 'm-neuron-form__label elementor-acceptance-field' );
		...
		echo '<div class="m-neuron-form__subgroup"><span class="elementor-field-option"><input ' . $form->get_render_attribute_string( 'input' . $item_index ) . '> ' . $label . '</span></div>';
	}
}
