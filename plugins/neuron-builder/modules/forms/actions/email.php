...
class Email extends Action_Base {
	...
	public function get_label() {
		return __( 'Email', 'neuron-builder' );
	}
	...
	public function register_settings_section( $widget ) {
		...
		$widget->add_control(
			...
			[
				'label' => __( 'To', 'neuron-builder' ),
				'type' => Controls_Manager::TEXT,
				'default' => get_option( 'admin_email' ),
				'placeholder' => get_option( 'admin_email' ),
				'label_block' => true,
				'title' => __( 'Separate emails with commas', 'neuron-builder' ),
				'render_type' => 'none',
			]
		);

		/* translators: %s: Site title. */
		$default_message = sprintf( __( 'New message from "%s"', 'neuron-builder' ), get_option( 'blogname' ) );
		...
		$widget->add_control(
			...
			[
				...
				'description' => sprintf( __( 'By default, all form fields are sent via %s shortcode. To customize sent fields, copy the shortcode that appears inside each field and paste it above.', 'neuron-builder' ), '<code>[all-fields]</code>' ),
				'label_block' => true,
				'render_type' => 'none',
			]
		);
		...
		$widget->add_control(
			...
			[
				'label' => __( 'From Email', 'neuron-builder' ),
				'type' => Controls_Manager::TEXT,
		...
		$widget->add_control(
			...
			[
				'label' => __( 'From Name', 'neuron-builder' ),
				'type' => Controls_Manager::TEXT,
		...
		$widget->add_control(
			...
			[
				'label' => __( 'Reply-To', 'neuron-builder' ),
		...
		$widget->add_control(
			...
			[
				...
				'options' => [
					...
					'page_url' => __( 'Page URL', 'neuron-builder' ),
					'user_agent' => __( 'User Agent', 'neuron-builder' ),
					'remote_ip' => __( 'Remote IP', 'neuron-builder' ),
				],
				'render_type' => 'none',
			]
		);
		...
		$widget->add_control(
			...
			[
				'label' => __( 'Send As', 'neuron-builder' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'html',
				'render_type' => 'none',
				'options' => [
	...
	/**
	 * @param \Neuron\Modules\Forms\Classes\Form_Record  $record
	 * @param \Neuron\Modules\Forms\Classes\Ajax_Handler $ajax_handler
	 */
	public function run( $record, $ajax_handler ) {
		...
		$fields = [
			...
			/* translators: %s: Site title. */
			'email_subject' => sprintf( __( 'New message from "%s"', 'neuron-builder' ), get_bloginfo( 'name' ) ),
		 ...
		 */
		$headers = apply_filters( 'neuron/forms/wp_mail_headers', $headers );
		 ...
		 */
		$fields['email_content'] = apply_filters( 'neuron/forms/wp_mail_message', $fields['email_content'] );
		 ...
		 */
		do_action( 'neuron/forms/mail_sent', $settings, $record );
