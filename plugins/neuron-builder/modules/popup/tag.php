...
use Neuron\Modules\DynamicTags\Tags\Base\Tag as DynamicTagsTag;
use Neuron\Modules\DynamicTags\Module as DynamicTagsModule;
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'toggle' => __( 'Toggle Popup', 'neuron-builder' ),
				],
			]
		);
