...
namespace Neuron\Modules\ShareButtons;
...
class Module extends Module_Base {
	...
	public function __construct() {
		...
		add_filter( 'neuron/frontend/localize_settings', [ $this, 'add_localize_data' ] );

		add_filter( 'neuron/editor/localize_settings', [ $this, 'add_localize_data' ] );
