...
namespace Neuron\Modules\GlobalWidget;
...
class Module extends Module_Base {
	...
	public function add_templates_localize_data( $settings ) {
		...
		$settings = array_replace_recursive( $settings, [
			...
			'i18n' => [
				'unlink' => __( 'Unlink', 'neuron-builder' ),
				'cancel' => __( 'Cancel', 'neuron-builder' ),
				'unlink_widget' => __( 'Unlink Widget', 'neuron-builder' ),
				'global' => __( 'Global', 'neuron-builder' ),
				'dialog_confirm_unlink' => __( 'This will make the widget stop being global. It\'ll be reverted into being just a regular widget.', 'neuron-builder' ),
				'global_widget_save_title' => __( 'Save your widget as a global widget', 'neuron-builder' ),
				'global_widget_save_description' => __( 'You\'ll be able to add this global widget to multiple areas on your site, and edit it from one single place.', 'neuron-builder' ),
				'linked_to_global' => __( 'Linked to Global', 'neuron-builder' ),
			],
		] );
	...
	private function add_hooks() {
		...
		add_filter( 'neuron/editor/localize_settings', [ $this, 'add_templates_localize_data' ] );
