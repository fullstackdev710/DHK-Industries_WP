...
class Fonts_Manager {
	...
	const CPT = 'neuron_font';

	const TAXONOMY = 'neuron_font_type';

	const FONTS_OPTION_NAME = 'neuron_fonts_manager_fonts';

	const FONTS_NAME_TYPE_OPTION_NAME = 'neuron_fonts_manager_font_types';
	 ...
	 * @param null $type
	 *
	 * @return array|bool|\Neuron\Modules\AssetsManager\Classes\Font_Base
	 */
	...
	public function register_post_type_and_tax() {
		$labels = [
			'name' => _x( 'Custom Fonts', 'CPT Name', 'neuron-builder' ),
			'singular_name' => _x( 'Font', 'CPT Singular Name', 'neuron-builder' ),
			'add_new' => __( 'Add New', 'neuron-builder' ),
			'add_new_item' => __( 'Add New Font', 'neuron-builder' ),
			'edit_item' => __( 'Edit Font', 'neuron-builder' ),
			'new_item' => __( 'New Font', 'neuron-builder' ),
			'all_items' => __( 'All Fonts', 'neuron-builder' ),
			'view_item' => __( 'View Font', 'neuron-builder' ),
			'search_items' => __( 'Search Font', 'neuron-builder' ),
			'not_found' => __( 'No fonts found', 'neuron-builder' ),
			'not_found_in_trash' => __( 'No fonts found in trash', 'neuron-builder' ),
			'parent_item_colon' => '',
			'menu_name' => _x( 'Custom Fonts', 'CPT Menu Name', 'neuron-builder' ),
		];
		...
		$taxonomy_labels = [
			'name' => _x( 'Font Types', 'Font type taxonomy general name', 'neuron-builder' ),
			'singular_name' => _x( 'Font Type', 'Font type singular name', 'neuron-builder' ),
			'search_items' => __( 'Search Font Types', 'neuron-builder' ),
			'popular_items' => __( 'Popular Font Types', 'neuron-builder' ),
			'all_items' => __( 'All Font Types', 'neuron-builder' ),
			'edit_item' => __( 'Edit Font Type', 'neuron-builder' ),
			'update_item' => __( 'Update Font Type', 'neuron-builder' ),
			'add_new_item' => __( 'Add New Font Type', 'neuron-builder' ),
			'new_item_name' => __( 'New Font Type Name', 'neuron-builder' ),
			'separate_items_with_commas' => __( 'Separate Font Types with commas', 'neuron-builder' ),
			'add_or_remove_items' => __( 'Add or remove Font Types', 'neuron-builder' ),
			'choose_from_most_used' => __( 'Choose from the most used Font Types', 'neuron-builder' ),
			'not_found' => __( 'No Font Types found.', 'neuron-builder' ),
			'menu_name' => __( 'Font Types', 'neuron-builder' ),
		];
	...
	public function post_updated_messages( $messages ) {
		$messages[ self::CPT ] = [
			...
			1 => __( 'Font updated.', 'neuron-builder' ),
			2 => __( 'Custom field updated.', 'neuron-builder' ),
			3 => __( 'Custom field deleted.', 'neuron-builder' ),
			4 => __( 'Font updated.', 'neuron-builder' ),
			/* translators: %s: date and time of the revision */
			5 => isset( $_GET['revision'] ) ? sprintf( __( 'Font restored to revision from %s', 'neuron-builder' ), wp_post_revision_title( (int) $_GET['revision'], false ) ) : false,
			6 => __( 'Font saved.', 'neuron-builder' ),
			7 => __( 'Font saved.', 'neuron-builder' ),
			8 => __( 'Font submitted.', 'neuron-builder' ),
			9 => __( 'Font updated.', 'neuron-builder' ),
			10 => __( 'Font draft updated.', 'neuron-builder' ),
		];
	...
	public function register_admin_menu() {
		$menu_title = _x( 'Custom Fonts', 'Custom Fonts', 'neuron-builder' );

		// add_submenu_page( 'neuron', 'Custom Fonts', 'Custom Fonts', 'administrator', 'custom_fonts', [ $this, 'custom_fonts_page' ] );
	...
	public function update_enter_title_here( $title, $post ) {
		if ( isset( $post->post_type ) && self::CPT === $post->post_type ) {
			return __( 'Enter Font Family', 'neuron-builder' );
		}
	...
	public function manage_columns( $columns ) {
		return [
			...
			'title' => __( 'Font Family', 'neuron-builder' ),
			'font_preview' => __( 'Preview', 'neuron-builder' ),
		];
	}
	...
	public function register_ajax_actions( Ajax $ajax ) {
		$ajax->register_ajax_action( 'neuron_assets_manager_panel_action_data', [ $this, 'assets_manager_panel_action_data' ] );
	}
	...
	protected function actions() {
		 ...
		 */
		do_action( 'neuron/fonts_manager_loaded', $this );
	}
