 ...
 * ACF 
 * 
 * Support custom fields of ACF
 * to fields that support 
 * dynamic content.
 * 
 * @since 1.0.0
 */

namespace Neuron\Modules\DynamicTags\ACF;
		...
		foreach ( $acf_groups as $acf_group ) {
			...
			foreach ( $fields as $field ) {
				...
				if ( $has_option_page_location ) {
					...
					$options[ $key ] = __( 'Options', 'neuron-builder' ) . ':' . $field['label'];
