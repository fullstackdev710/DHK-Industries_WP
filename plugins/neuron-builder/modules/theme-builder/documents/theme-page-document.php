...
abstract class Theme_Page_Document extends Theme_Document {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'page_template',
			[
				'label' => __( 'Page Layout', 'neuron-builder' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => __( 'Default', 'neuron-builder' ),
					PageTemplatesModule::TEMPLATE_CANVAS => __( 'Elementor Canvas', 'neuron-builder' ),
					PageTemplatesModule::TEMPLATE_HEADER_FOOTER => __( 'Elementor Full Width', 'neuron-builder' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'raw' => __( 'Default Page Template from your theme', 'neuron-builder' ),
				'separator' => 'none',
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::RAW_HTML,
				'raw' => __( 'No header, no footer, just Elementor', 'neuron-builder' ),
				'separator' => 'none',
				'content_classes' => 'elementor-descriptor',
				'condition' => [
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::RAW_HTML,
				'raw' => __( 'This template includes the header, full-width content and footer', 'neuron-builder' ),
				'separator' => 'none',
				'content_classes' => 'elementor-descriptor',
				'condition' => [
