...
abstract class Theme_Document extends Library_Document {
	...
	public static function get_create_url() {
		...
		return add_query_arg( [ 'template_type' => static::get_site_editor_type() ], $base_create_url );
	}
	...
	public function get_location_label() {
		...
		if ( ! $supported ) {
			$label .= ' (' . __( 'Unsupported', 'neuron-builder' ) . ')';
		}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'preview_settings',
			[
				'label' => __( 'Preview Settings', 'neuron-builder' ),
		...
		$this->add_control(
			'preview_type',
			[
				'label' => __( 'Preview Dynamic Content as', 'neuron-builder' ),
				'label_block' => true,
		...
		$this->add_control(
			'preview_search_term',
			[
				'label' => __( 'Search Term', 'neuron-builder' ),
				'export' => false,
				'condition' => [
					'preview_type' => 'search',
				],
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Apply & Preview', 'neuron-builder' ),
				'label_block' => true,
				'show_label' => false,
				'text' => __( 'Apply & Preview', 'neuron-builder' ),
				'separator' => 'none',
				'event' => 'neuronThemeBuilder:ApplyPreview',
			]
		);
