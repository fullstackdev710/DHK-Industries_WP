...
use Neuron\Modules\ThemeBuilder\Conditions\Condition_Base;
...
class Conditions_Manager {
	...
	public function admin_columns_headers( $posts_columns ) {
		...
		$posts_columns = array_slice( $posts_columns, 0, $offset, true ) + [
			'instances' => __( 'Conditions', 'neuron-builder' ),
	...
	public function admin_columns_content( $column_name, $post_id ) {
		...
		if ( ! empty( $instances ) ) {
			...
			echo __( 'None', 'neuron-builder' );
		}
	}

	public function register_ajax_actions( $ajax_manager ) {
		$ajax_manager->register_ajax_action( 'neuron_theme_builder_save_conditions', [ $this, 'ajax_save_theme_template_conditions' ] );
	}
	...
	private function register_condition( $id, $args = [] ) {
		...
		$class_name = '\\Neuron\\Modules\\ThemeBuilder\\Conditions\\' . $class_name;
