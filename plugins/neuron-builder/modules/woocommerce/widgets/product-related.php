...
class Product_Related extends Base_Widget {

	protected $query_args;

	public function get_name() {
		return 'neuron-woo-product-related';
	}

	public function get_title() {
		return __( 'Product Related', 'neuron-builder' );
	}

	public function get_icon() {
		return 'eicon-product-related neuron-badge';
	}
	...
	protected function get_query() {
		$this->query_args = [
			...
			'post__in' => wc_get_related_products( get_the_ID(), $this->get_settings('posts_per_page') ? $this->get_settings('posts_per_page') : 4, [ get_the_ID() ] )
		];
