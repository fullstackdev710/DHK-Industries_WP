<?php
namespace Neuron\Modules\QueryControl\Classes;

use Elementor\Widget_Base;
use Neuron\Modules\QueryControl\Module;
...
class Elementor_Post_Query {
	...
	public function get_query_args() {
		...
		if ( 'current_query' === $post_type ) {
			 ...
			 */
			$current_query_vars = apply_filters_deprecated( 'neuron/query_control/get_query_args/current_query', [ $current_query_vars ], '2.5.0', 'elementor/query/get_query_args/current_query' );
	...
	public function pre_get_posts_query_filter( $wp_query ) {
		if ( $this->widget ) {
			...
			do_action_deprecated( "neuron/{$widget_name}/query/{$query_id}", [ $wp_query, $this->widget ], '2.5.0', "elementor/query/{$query_id}" );//@TODO
