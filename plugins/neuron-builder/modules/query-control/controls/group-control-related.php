...
class Group_Control_Related extends Group_Control_Query {
	...
	protected function init_fields_by_name( $name ) {
		...
		$fields['post_type']['options']['related'] = __( 'Related', 'neuron-builder' );
		...
		$related_fallback = [
			...
			'options' => [
				'fallback_none' => __( 'None', 'neuron-builder' ),
				'fallback_by_id' => __( 'Manual Selection', 'neuron-builder' ),
				'fallback_recent' => __( 'Recent Posts', 'neuron-builder' ),
			],
