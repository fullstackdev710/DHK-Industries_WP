<?php
namespace Neuron\Modules\QueryControl;

use Elementor\Controls_Manager;
use Elementor\Core\Common\Modules\Ajax\Module as Ajax;
use Elementor\Widget_Base;
use Neuron\Base\Module_Base;
use Neuron\Modules\QueryControl\Controls\Group_Control_Posts;
use Neuron\Modules\QueryControl\Controls\Group_Control_Query;
use Neuron\Modules\QueryControl\Controls\Group_Control_Related;
use Neuron\Modules\QueryControl\Classes\Elementor_Post_Query;
use Neuron\Modules\QueryControl\Classes\Elementor_Related_Query;
use Neuron\Modules\QueryControl\Controls\Query;
use Neuron\Plugin;
...
class Module extends Module_Base {
	...
	/**
	 * @param \Neuron\Base\Base_Widget $widget
	 * @param string $name
	...
	public function register_ajax_actions( $ajax_manager ) {
		...
		$ajax_manager->register_ajax_action( 'neuron_panel_posts_control_filter_autocomplete', [ $this, 'ajax_posts_filter_autocomplete' ] );
	}
