 ...
 * Custom CSS Module
 * 
 * Allows user to add CSS in sections/elements/columns.
 * 
 * @since 1.0.0
 */

namespace Neuron\Modules\CustomCss;
...
class Module extends Module_Base {
	...
	public function replace_go_pro_custom_css_controls( $controls_stack ) {
		...
		$controls_stack->start_controls_section(
			'section_custom_css',
			[
				'label' => __( 'Custom CSS', 'neuron-builder' ),
				'tab' => $old_section['tab'],
			]
		);
		...
		$controls_stack->add_control(
			'custom_css_title',
			[
				'raw' => __( 'Add your own custom CSS here', 'neuron-builder' ),
		...
		$controls_stack->add_control(
			...
			[
				'raw' => __( 'Use "selector" to target wrapper element. Examples:<br>selector {color: red;} // For main element<br>selector .child-element {margin: 10px;} // For child element<br>.my-class {text-align: center;} // Or use any custom selector', 'neuron-builder' ),
				'type' => Controls_Manager::RAW_HTML,
	...
	public function localize_settings( array $settings ) {
		$settings['i18n']['custom_css'] = __( 'Custom CSS', 'neuron-builder' );
